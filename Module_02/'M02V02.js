...
//TODO Output Working steps
// TODO process== filter ||
// TODO short by rating ||
// TODO slice top(first)  3 ||

const topElectronicsProducts = rawApiData
  .filter((product) => product.category === "Electronics")
  .sort((a, b) => b.rating - a.rating) //top to los all product show
  .slice(0, 3) //first 3 product
  //   .map((product) => ({ NAME: product.productName }))   //return object shorthand || oneliner
  .map((product) => {
    return {
